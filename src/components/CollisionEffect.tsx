  ...
  useFrame((state) => {
    if (particles.current) {
      ...
      for (let i = 0; i < particleCount; i++) {
        ...
        positions[ix] =
          particlesPosition[ix] +
          Math.sin(state.clock.elapsedTime * 10 + i) * 0.02;
        positions[iy] =
          particlesPosition[iy] +
          Math.cos(state.clock.elapsedTime * 10 + i) * 0.02;
        positions[iz] =
          particlesPosition[iz] +
          Math.sin(state.clock.elapsedTime * 10 + i * 0.5) * 0.02;
      }
